                ...
                <div class="card-header d-flex">
                    ...
                    @if($projet->statut === "en cours")
                        @if($current_user->autorisations)
                            @if(in_array("peux ajouter une avec", json_decode($current_user->autorisations, true)))
                        ...
                        <table id="multi-filter-select" class="display table table-striped table-hover">
                            ...
                            @foreach($avecs as $avec)
                                <tr class="ligne ln-pdf">
                                    ...
                                    <td>
                                        <a class="btn-sm text-primary" href="{{ route("gestionprojet.afficher_avec", $avec->id) }}"><span class="bi-eye"></span></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
