                            ...
                            <tbody>
                                @foreach($agenda as $tache)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn-sm text-danger" value="{{ $tache->id }}" onclick="loadidtache(this)" data-bs-toggle="modal" data-bs-target="#SupRowModal" href="#"><span class="bi-trash-fill"></span></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
