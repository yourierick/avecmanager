        ...
        <div class="col-md-4">
            <div class="btn-group dropdown" style="float: right;">
                ...
                <ul class="dropdown-menu p-2" role="menu" style="background-color: #ffffff; border: 1px solid blue">
                    <li>
                        <a class="dropdown-item btn btn-outline-secondary perso" href="{{ route("report.rapport_transactions_du_membre", [$membre->id, $projet->id, $avec->id]) }}"><span class="bi-file-earmark-excel"> rélevé des transactions</span></a>
                    </li>
                </ul>
            </div>
        </div>
