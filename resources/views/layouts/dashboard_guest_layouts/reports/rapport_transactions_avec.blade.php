        ...
        <div class="col-md-4">
            <div class="btn-group dropdown" style="float: right;">
                ...
                <ul class="dropdown-menu p-2" role="menu" style="background-color: #ffffff; border: 1px solid blue">
                    <li>
                        <a class="dropdown-item btn btn-outline-secondary perso" href="{{ route('guest.report_analytique_de_avec', [$avec->id, $projet->id]) }}"><span class="bi-file-earmark-excel"> rapport analytique de l'avec</span></a>
                    </li>
                </ul>
            </div>
        </div>
