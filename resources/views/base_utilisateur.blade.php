        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
            <div class="sidebar-content">
                <ul class="nav nav-secondary">
                    ...
                    @if($current_user->fonction === "assistant suivi et évaluation")
                        <li class="nav-item">
                            <a data-bs-toggle="collapse" href="#base">
                                <i class="fas fa-plus-circle"></i>
                                <p>DOCUMENT DE SUIVI</p>
                            ...
                            <div class="collapse ml-3" id="base">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="#">
                                            <span class="bi-wordpress" style="font-size: 10pt"> plan de suivi</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <span class="bi-search" style="font-size: 10pt"> suivi des indicateurs</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
